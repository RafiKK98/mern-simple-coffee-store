...
const CoffeeCard = ({ coffee, coffees, setCoffees }) => {
    ...
    return (
        <div className="card card-side bg-[#F5F4F1] rounded-xl">
            <figure>
                <img src={photo} alt="Movie" />
            </figure>
            <div className="flex justify-between items-center w-full pr-4">
                <div className="ml-6">
                    <h2 className="text-xl mb-4 text-[#1B1A1A] font-semibold">Name: <span className="text-[#5C5B5B] font-normal">{name}</span></h2>
                    <h2 className="text-xl mb-4 text-[#1B1A1A] font-semibold">Chef: <span className="text-[#5C5B5B] font-normal">{chef}</span></h2>
                    <h2 className="text-xl mb-4 text-[#1B1A1A] font-semibold">Price: <span className="text-[#5C5B5B] font-normal">890 Taka</span></h2>
                </div>
                <div className="card-actions justify-end">
                    <div className="btn-group btn-group-vertical space-y-4">
                        <Link to={`coffeeDetails/${_id}`}>
                            <button className="p-3 rounded-md bg-[#D2B48C] hover:brightness-75">
                        ...
                        <button
                            ...
                            className="p-3 rounded-md bg-[#EA4744] hover:brightness-75">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
